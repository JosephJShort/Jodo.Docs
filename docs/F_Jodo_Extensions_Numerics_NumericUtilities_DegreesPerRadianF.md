# NumericUtilities.DegreesPerRadianF Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:Jodo.Extensions.Numerics.NumericUtilities.DegreesPerRadianF"\]
...
**C#**<br />
``` C#
public const float DegreesPerRadianF = 57.29578f
```
