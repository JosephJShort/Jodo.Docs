# NumericUtilities.DegreesPerRadianM Field
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "F:Jodo.Extensions.Numerics.NumericUtilities.DegreesPerRadianM"\]
...
**C#**<br />
``` C#
public static readonly decimal DegreesPerRadianM
```
