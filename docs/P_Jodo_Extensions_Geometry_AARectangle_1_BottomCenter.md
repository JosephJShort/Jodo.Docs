# AARectangle(*N*).BottomCenter Property 
 _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "P:Jodo.Extensions.Geometry.AARectangle`1.BottomCenter"\]
...
**C#**<br />
``` C#
public Vector2<N> BottomCenter { get; }
```
